...
# In the first line, we use square brackets to create a list that
...
list_out_of_string = list(235)  # TypeError: 'int' is not iterable

# So, the list function creates a list containing each element
...
# of a non-iterable object. A list itself is also an iterable object.
...
# list. There is a built-in function called len that can be applied
...
# and [] as applied to string: it may not result in what you
# expected. 
