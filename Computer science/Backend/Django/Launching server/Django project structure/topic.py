...
# the service, and it should have at least one application. To
# isolate units of code with different business logic, you can
# create more applications. For example, an online store project
# can have the blog, authors, forum, and support applications.
...
# django-admin will be a good guide to the common structure of
# a project. Note that different versions of Django have different
...
# Having executed these commands, you'll get a whole file tree
# for the project. The folder "store" will be the root of your site
# and the inner folder "blog" will be the first application we've
# created. Remember the MTV paradigm? Its components can be
# linked with the following files and folders:
...
# with custom attributes; it reflects a structured piece of data
# from your application that you want to store persistently or
# temporarily. For example, in a shop application, it can be a
# customer, a project, and a purchase; in a blog, business objects
...
# Django has built-in Model class for creating database models.
# In the snippet above we create our model for posts that has two
...
# User is registered person in your web service and the Group
# is a collection of users. We'll create some of those and discuss
# how to work with them in detail later when we attach a
...
# Here's hwo the simplest template file may look like:
# <!DOCTYPE html>
# <title>Example</title>
# <h1>First template</h1>
# <p>This is a simple html-page without any additional functionality.</p>

# Yes, its just a plain HTML file. YOu will learn how to use
# template languages and add content in CSS or JavaScript in the
# later topics.
...
# you understand better the structure of Django projects!
