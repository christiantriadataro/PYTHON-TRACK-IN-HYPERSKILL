...
# Python has many libraries that provides ready-to-use
...
# Python standard library contains such contains as
# sorted, min, max, which represents algorithms for
...
#   list or tuple. An example of collections.deque,
