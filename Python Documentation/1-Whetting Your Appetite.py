...
# too slow. Perhaps you're writing a test suite for such a library and find writing
# the test code a tedious task. Or maybe you've written a program that could
# use an extension language, and you don't want to design and implement a
# whole new language for your application.

# Python is just the language for you.

# You could write a Unix shell script or Windows batch files for some of these
# task, but shell scripts are best at moving around files and changing text data,
# not well-suited for GUI application or games. You could write a C/C++/Java
...
# can offer. On the other hand, Python also offers much more error checking
...
# that you can use as the basis of your program - or as examples to start
# learning to program in Python. Some of these modules provide things like file
# I/O, system calls, sockets, and even interfaces to graphical
...
# written in Python are typically much shorten than equivalent C, C++, or
...
# Pythohn is extensible: if you know howto program in C it is easy to add a
